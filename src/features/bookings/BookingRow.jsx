...
import { HiArrowDownOnSquare, HiArrowUpOnSquare, HiEye, HiOutlineTrash } from "react-icons/hi2";
...
//only checked out can be deleted
//add the button
//add the modal around it
// get the deleteButtonMutate
// pass the id
// show the success
// open(opens) , window (name)
